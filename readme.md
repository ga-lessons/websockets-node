...
Mozilla created a multiplayer web-based game called [BrowserQuest](http://browserquest.mozilla.org/) using HTML canvas and WebSockets. You're going to play it for the next 7 minutes.
